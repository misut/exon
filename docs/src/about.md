...
- [codon](https://github.com/misut/codon) — documentation-site
  generator that produced this site from the markdown under
  `docs/src/`
- [tomlcpp](https://github.com/misut/tomlcpp) — TOML parser used to
  load `exon.toml`
- [jsoncpp](https://github.com/misut/jsoncpp) — JSON parser /
  emitter for cross-tool data interchange
